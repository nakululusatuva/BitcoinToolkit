...
SRC_SCRIPT      := $(wildcard ${DIR_SRC_SCRIPT}/*.c)
...
BUILD_SCRIPT    := $(patsubst %.c,${DIR_BUILD_SCRIPT}/%.o, $(notdir ${SRC_SCRIPT}))

$(TARGET) : $(BUILD) $(BUILD_cJSON) $(BUILD_CODEC) $(BUILD_CONTAINER) $(BUILD_SCRIPT)
	$(CC) $^ -o $@ -lcrypto $(CFLAGS)
...
${DIR_BUILD_SCRIPT}/%.o : ${DIR_SRC_SCRIPT}/%.c
	$(CC) -c $^ -o $@ $(CFLAGS)
